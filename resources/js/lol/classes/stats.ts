...
export default class Stats {
    ...
    ap: number = 0;
    armor: number = 0;
    armor_pen_percent: number = 0;
    armor_pen_flat: number = 0;
    as_percent: number = 0;
    base_as: number = 0;
    crit_percent: number = 0;
    hp: number = 0;
    hp_regen_percent: number = 0;
    life_steal_percent: number = 0;
    magic_pen_percent: number = 0;
    magic_pen_flat: number = 0;
    mr: number = 0;
    mp: number = 0;
    mp_regen_percent: number = 0;
    ms: number = 0;
    ms_percent: number = 0;
    ...
    add_item_stats(stats: ItemStats) {
        this.ad += stats.ad;
        this.ap += stats.ap;
    ...
    add_item_mythic_stats(stats: ItemMythicStats, nb_legendary: number) {
